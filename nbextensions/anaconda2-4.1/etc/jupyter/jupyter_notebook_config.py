...
import sys
sys.path.append('anaconda2-4.1/share/jupyter/nbextensions')

c.NotebookApp.extra_template_paths = ['anaconda2-4.1/share/jupyter/templates']
c.NotebookApp.extra_static_paths = ['anaconda2-4.1/share/jupyter/static']
