...
#import sys
#sys.path.append('/opt/jupyter/share/nbextensions')

################### added by install script ##################
c.IPKernelApp.pylab = 'inline'
import sys
sys.path.append('anaconda3-4.1/share/jupyter/nbextensions')

c.NotebookApp.extra_template_paths = ['anaconda3-4.1/share/jupyter/templates']
c.NotebookApp.extra_static_paths = ['anaconda3-4.1/share/jupyter/static']
